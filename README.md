...
### Sigma
The sigma determines the intensity of the blur that is applied to the image (this filters noise and unwanted 
edges): 
...
### High threshold
Pixels above this value are considered part of an edge. The program gives you information about the 
...
### Low threshold
Pixels below this value are definetely not part of an edge. Pixels between low and high MIGHT be part of 
